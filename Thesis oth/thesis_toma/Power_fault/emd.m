%
% modified implementation written by Zabir
% 
% I wrote a slightly modified version to make it 
% faster
function imf = emd(x);
...
while (1) % the stop criterion is tested at the end of the loop
   ...
   while SD > 0.25 % power signal properties
      % while the standard deviation is higher than 0.25 (typical value)
