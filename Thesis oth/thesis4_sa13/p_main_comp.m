...
img = imread('lena_gray_512.tif'); % Read image
...
%noise add
     %---------compression--------
imwrite(Is,'co1.jpeg','Quality',90);
watermarked_image3=imread('co1.jpeg');
IW1=double(watermarked_image3);
figure,
imshow(watermarked_image3);
